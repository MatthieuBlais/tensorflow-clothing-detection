...
def visualize_boxes_and_labels_on_image_array(image,
  ...
  for box, color in box_to_color_map.items():
    ...
    boxes.append({"xmin":xmin, "ymin":ymin, "xmax":xmax, "ymax":ymax, "label":{"name": (box_to_display_str_map[box][0].split(":"))[0], "value": float((box_to_display_str_map[box][0].split(":"))[1].replace("%","").strip())} })
...
def visualize_boxes_and_labels_on_image_array_2(image,
                                              boxes,
                                              classes,
                                              scores,
                                              category_index,
...
def visualize_boxes_and_labels_on_image_array_3(image,
                                              boxes,
                                              classes,
                                              scores,
                                              category_index,
                                              ...
                                              min_score_thresh=.5,
                                              agnostic_mode=False,
                                              line_thickness=4):  # Draw all boxes onto image.
  for box in boxes:
    ...
    draw_bounding_box_on_image_array(
        ...
        color=STANDARD_COLORS[
              classes.index(box["label"]) % len(STANDARD_COLORS)],
        thickness=line_thickness,
